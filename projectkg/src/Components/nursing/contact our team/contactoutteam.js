        ...
        <div className="container-fluid backgroundapa" id="footer">
            ...
            <div className="container-fluid ">
                <div className="row justify-content-between ">
                    ...
                    <div className="col-lg-6 row boder mb-5 ms-1 bg-white ">
                        <div className="col-lg-5">
                            <img src={BH} className="col-lg-12 col-12"/>
                            
                        </div>
                        <div className="col-lg-7">
                          <h4 className="mt-4">Kamal Vignesh</h4>
                          <p> <FontAwesomeIcon icon={faGraduationCap} className="me-2 colr"/>Bussiness Head</p>
                          <p> <FontAwesomeIcon icon={faPhone}  className="me-2 colr"/>86954 33663</p>
                          <p> <FontAwesomeIcon icon={faEnvelope}  className="me-1 colr"/>kamalvignesh.v@kggeniuslabs.com </p>
